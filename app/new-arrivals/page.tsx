...
const newArrivals = [
  ...
  },
  {
    ...
    price: 46.99,
    originalPrice: 58.99,
    image: '/images/products/小天鹅芭蕾套装-Little-Swan-Ballet-Set/Character Front View.png',
    rating: 4.8,
    reviews: 145,
    badge: 'Elegant',
  ...
  {
    id: 16,
    name: 'Strawberry Cake Princess Dress',
    price: 44.99,
    originalPrice: 56.99,
    image: '/images/products/草莓蛋糕公主裙-Strawberry-Cake-Princess-Dress/Character Front View.png',
    rating: 4.9,
    reviews: 198,
    badge: 'Sweet',
...
const filters = {
  ...
  collections: [
    ...
    { id: 'costume', name: 'Costume Collection' },
